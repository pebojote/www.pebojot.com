---
layout: post
title: Is the functionality does not meet the user's needs? Perhaps it is useless
...
<div class="desktop__size " style="text-align: center;font-family:sans-serif;word-spacing: 0px;">
    <h2>Is the functionality does not meet the user's needs? Perhaps it is useless</h2>
</div>
